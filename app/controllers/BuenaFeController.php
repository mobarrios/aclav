...
class BuenaFeController extends BaseController
{
	...
	public function postEditjugador()
	{
		...
		else
		{
		 ...
		 return $this->getEdit(Crypt::encrypt(Session::get('id')),Crypt::encrypt(Session::get('torneo_id')));
	...
	public function postUniforme()
	{
	  
	  	$o2 = o2::find(Input::get('o2_id'));

	  	$o2->uniforme_claro_camiseta 	= Input::get('uniforme_claro_camiseta');
		$o2->uniforme_claro_short 		= Input::get('uniforme_claro_short');
	  	$o2->uniforme_oscuro_camiseta 	= Input::get('uniforme_oscuro_camiseta');
	  	$o2->uniforme_oscuro_short 		= Input::get('uniforme_oscuro_short');
	  	$o2->uniforme_tv_camiseta 		= Input::get('uniforme_tv_camiseta');
	  	$o2->uniforme_tv_short 			= Input::get('uniforme_tv_short');
	  	$o2->save();
