...
{
	protected $moduloId = '60';
	protected $up;
	protected $imgPath 	= 'uploads/contenidos/autoridad/'; 
	...
	public function getIndex()
	{
		...
		$data['modulo'] = "Autoridad";
		$data['model']	= Autoridad::all();

		return View::make('contenido.autoridad.index')->with($data);
	}
	...
	public function getNew()
	{
		...
		$data['modulo'] = "Autoridad";
		$data['action'] = "create";
		return View::make('contenido.autoridad.form')->with($data);
	}
   ...
   return Redirect::back()->with('danger','Error en el tamaño del  archivo')->withInput();
	...
	public function postEdit($id)
	{
		...
		if($input['imagen'] != null)
		{
			...
			if($up != false)
			{
				$this->up->del($autoridad->imagen, $this->imgPath);
				
				$input['imagen'] = $up;
			}	
		}else
		{
			$input['imagen'] = $autoridad->imagen;
		}
		

		$autoridad->fill($input);
		$autoridad->save();
