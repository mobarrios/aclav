...
<div class="panel panel-default">
	<div class="panel-heading">	
		...
		<b class="pull-right">( Nro.{{$partido->numero_partido}} ) {{$partido->local_equipo_id->sigla}} / {{$partido->visita_equipo_id->sigla}}</b>
	</div>
		...
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<form action="perfil_arbitro/traslado" id='form-traslado' method="POST" class="form-horizontal" role="form">
