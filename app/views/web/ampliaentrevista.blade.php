...
<div class="col-lg-12 col-md-4 col-sm-4 col-xs-6"> 
                    ...
                    <div class="blogtext">
                                    ...
                                    <h2><font color="#f2293a">{{$entrevista->titulo}}</font></h2>
                                    <div class="clearfix"></div>
                                    <div class="blogmetas">
                                        <ul>
                                            <font color="#ffffff"><li> <i class="fa fa-align-justify"></i> {{$entrevista->created_at}}</font></li>
                                    ...
                                    <div> 
                                     <img style="float: left; margin-right:10px" src="uploads/contenidos/entrevistas/{{$entrevista->imagen}}"  width="350"><font color="#ffffff">{{$entrevista->cuerpo}}</font></div>
