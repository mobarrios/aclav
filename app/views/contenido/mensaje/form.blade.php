...
<div class="panel panel-default">
	...
	<div class="panel-body">
	    ...
	    {{ Form::label('label', 'Mensaje', array('class' => 'col-sm-2 control-label')) }}

		    <div class="col-sm-10">
			    {{ Form::text ('mensaje', Input::old('mensaje'), array('class' => 'form-control')) }}
			</div>
		</div>
	    ...
	    {{ Form::label('label', 'Estado', array('class' => 'col-sm-2 control-label')) }}
		    ...
		    <div class="col-sm-10">
			    ...
			    {{ Form::select('estado',array('1'=>'Activo','0'=>'No Activo') )}}
