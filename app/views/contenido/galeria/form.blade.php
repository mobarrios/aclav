...
<div class="panel panel-default">
	...
	<div class="panel-body">
	    ...
	    {{ Form::close() }}
 		...
 		{{ Form::open( array('class'=>'form-horizontal','enctype' => 'multipart/form-data','url' => 'galeria/imagenes') ) }}

			<div class="form-group">	  
			{{ Form::label('label', 'Imagenes', array('class' => 'col-sm-2 control-label')) }}
	    ...
	    {{ Form::label('label', 'Fuente', array('class' => 'col-sm-2 control-label')) }}
			...
			@if(isset($modelo))
				...
				@foreach($modelo->galeriaimagenes as $imagen)

					<div class="col-xs-1 col-sm-1 col-md-1 col-lg-1">
						<a href="uploads/contenidos/galeria/{{$imagen->galeria_id}}/{{$imagen->imagen}}" class="thumbnail">
							<img src="uploads/contenidos/galeria/{{$imagen->galeria_id}}/{{$imagen->imagen}}" >
						</a>
					</div>
				@endforeach
			@endif
