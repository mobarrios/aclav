  ...
  <div class="slick posts posts-slider posts--slider-top-news">
    ...
    <div class="slick__slide">
      ...
      <div class="posts__item posts__item-has-img posts__item--category-1">
        ...
        <figure class="posts__thumb">
          <img src="assets/images/samples/hero-slide1.jpg" alt="" class="duotone-img" data-gradient-map="#282840, #f92552">
        </figure>
        <!-- Main Image / End -->
  
        <!-- Player Image -->
        <div class="posts__img-player">
          <img src="assets/images/samples/hero-unit-player.png" alt="Hero Unit Image">
        </div>
        <!-- Player Image / End -->
        ...
        <div class="posts__inner">
          ...
          <h3 class="posts__title"><a href="detalle_noticia.html"><font color="#ffffff">River Plate conmemora un año de su ascenso y regreso a la A1</font></a></h3>
    ...
    <div class="slick__slide">
      ...
      <div class="posts__item posts__item--category-2">
        ...
        <!-- Main Image -->
        <figure class="posts__thumb">
          <img src="assets/images/samples/hero-slide2.jpg" alt="" class="duotone-img" data-gradient-map="#282840, #9e69ee">
        </figure>
        <!-- Main Image / End -->
        ...
        <div class="posts__inner">
          ...
          <h3 class="posts__title"><a href="detalle_noticia.html"><font color="#ffffff">Martín Ramos: "Vamos a dar todo para hacer historia"</font></a></h3>
    ...
    <div class="slick__slide">
      ...
      <div class="posts__item posts__item--category-1">
        ...
        <!-- Main Image -->
        <figure class="posts__thumb">
          <img src="assets/images/samples/hero-slide3.jpg" alt="" class="duotone-img" data-gradient-map="#282840, #f92552">
        </figure>
        <!-- Main Image / End -->
        ...
        <div class="posts__inner">
          ...
          <h3 class="posts__title"><a href="detalle_noticia.html"><font color="#ffffff">Liga Argentina BNA: Empieza la gran final entre Bolívar y UPCN</font></a></h3>
    ...
    <div class="slick__slide">
      ...
      <div class="posts__item posts__item--category-3">
        ...
        <!-- Main Image -->
        <figure class="posts__thumb">
          <img src="assets/images/samples/hero-slide4.jpg" alt="" class="duotone-img" data-gradient-map="#282840, #0fe3ab">
        </figure>
        <!-- Main Image / End -->
        ...
        <div class="posts__inner">
          ...
          <h3 class="posts__title"><a href="detalle_noticia.html"><font color="#ffffff">Liga Argentina BNA: Personal Bolívar es el nuevo campeón</font></a></h3>
          <footer class="posts__footer">
          ...
          <div class="widget__content card__content">
                <ul class="widget-results__list">
                  ...
                  <li class="widget-results__item">
                    <h5 class="widget-results__title">Viernes, Marzo 31</h5>
                    <div class="widget-results__content">
                      ...
                      <div class="widget-results__result">
                        <div class="widget-results__score">
                          <span class="widget-results__score-winner">0</span> - <span class="widget-results__score-loser">0</span>
                          <div class="widget-results__status">Próximo Partido</div>
                        </div>
                      </div>
      ...
      <div class="posts__item posts__item--category-1">
        <div class="widget__content card__content">
                <ul class="widget-results__list">
                  ...
                  <li class="widget-results__item">
                    <h5 class="widget-results__title">Sabado, Abril 01</h5>
                    <div class="widget-results__content">
                      <div class="widget-results__team widget-results__team--first">
                        <figure class="widget-results__team-logo">
        ...
        <div class="row">
          ...
          <div class="content col-md-8">
            ...
            <div class="card card--clean">
              <h4><img src="assets/images/samples/bna.gif"></h4>
              <div class="card__content">
              ...
              <div class="post-grid__item col-sm-6">
                <div class="posts__item posts__item--card posts__item--category-1 card">
                  ...
                  <div class="posts__inner card__content">
                    ...
                    <h6 class="posts__title"><a href="detalle_noticia.html">Liga Argentina BNA: Bolívar venció a UPCN y se llevó la Final 1</a></h6>
              ...
              <div class="post-grid__item col-sm-6">
                <div class="posts__item posts__item--card posts__item--category-1 card">
                  ...
                  <div class="posts__inner card__content">
                    ...
                    <h6 class="posts__title"><a href="detalle_noticia.html">Fabián Armoa y la confianza plena en el equipo de UPCN</a></h6>
              ...
              <div class="post-grid__item col-sm-6">
                <div class="posts__item posts__item--card posts__item--category-1 card">
                  ...
                  <div class="posts__inner card__content">
                    <a href="#" class="posts__cta"></a>
                    <time datetime="2016-08-23" class="posts__date">Abril 06, 2017</time>
                    <h6 class="posts__title"><a href="detalle_noticia.html">Demián González: “Tenemos que imponer nuestro juego”</a></h6>
              ...
              <div class="post-grid__item col-sm-6">
                <div class="posts__item posts__item--card posts__item--category-1 card">
                  ...
                  <div class="posts__inner card__content">
                    <a href="#" class="posts__cta"></a>
                    <time datetime="2016-08-23" class="posts__date">Abril 06, 2017</time>
                    <h6 class="posts__title"><a href="detalle_noticia.html">Copa Argentina: Obras UDAP Vóley, campeón en Neuquén</a></h6>
