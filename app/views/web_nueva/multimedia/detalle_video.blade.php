...
<br>
              <div class="video-container">
                    <iframe width="560" height="315" src="https://www.youtube.com/embed/oy6uRudfk28?ecver=1" frameborder="0" allowfullscreen></iframe>
              </div>
              ...
              <div class="card__content">
                ...
                <header class="post__header">
                  <h2 class="post__title"><p>Los destacados de la temporada: Lazo y Poglajen, mejores puntas</p></h2>
          ...
          <div id="sidebar" class="sidebar col-md-4">
            <aside class="widget widget--sidebar card widget-popular-posts">
              <div class="widget__title card__header">
                <h4><img src="assets/images/banner003.png"></h4>
              </div>
            </aside>
            <aside class="widget widget--sidebar card widget-popular-posts">
              <div class="widget__title card__header">
    ...
    <script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0],p=/^http:/.test(d.location)?'http':'https';if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src=p+"://platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
            ...
            <aside class="widget card widget--sidebar widget-player widget-player--alt">
              <div class="widget__title card__header">
                ...
                <h4><img src="assets/images/jugador.png"></h4>
             </aside>
